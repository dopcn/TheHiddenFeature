...
#ifndef THEHIDDENFEATURE_SWIFT_H
#define THEHIDDENFEATURE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TheHiddenFeature",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC16TheHiddenFeature18MultipeerTransport")
...
@class NSData;
@class MCSession;
@interface MultipeerTransport (SWIFT_EXTENSION(TheHiddenFeature)) <MCNearbyServiceAdvertiserDelegate>
...
@class NSString;
@interface MultipeerTransport (SWIFT_EXTENSION(TheHiddenFeature)) <MCNearbyServiceBrowserDelegate>
...
@class NSProgress;
@class NSURL;
@interface MultipeerTransport (SWIFT_EXTENSION(TheHiddenFeature)) <MCSessionDelegate>
